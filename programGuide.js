...
(function () {
    ...
    const FILE_MAP = {
        ...
        'desktopBoot.js': { category: 'Desktop Boot', role: 'Το βασικό desktop boot sequence, μαζί με weather UI, calendar/backup wiring και desktop sync orchestration.' },
        ...
        'desktopBoot.js': { category: 'Desktop Boot', role: 'Το βασικό desktop boot sequence: navbar, initial render, weather sync, backup/calendar wiring και onload coordination.' },
