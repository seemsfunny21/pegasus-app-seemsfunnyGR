/* ==========================================================================
   PEGASUS OS - MASTER MANIFEST & REGISTRY (v18.87)
...
window.PegasusManifest = {
    ...
    metadata: {
        ...
        engine_version: "v18.87 mobile cleanup, centered actions and data manager"
    },
...
console.log("🏛️ PEGASUS MANIFEST v18.87 LOADED. MOBILE CLEANUP + DATA MANAGER READY.");
