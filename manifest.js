/* ==========================================================================
   PEGASUS OS - MASTER MANIFEST & REGISTRY (v18.77)
...
window.PegasusManifest = {
    ...
    metadata: {
        ...
        engine_version: "v18.77 Parking Geo Map Restore + Stable Button Labels"
    },
...
console.log("🏛️ PEGASUS MANIFEST v18.77 LOADED. PARKING GEO MAP RESTORE + STABLE LABELS READY.");
