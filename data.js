/* ==========================================================================
    PEGASUS DATA ENGINE - v10.1.7 (OMNI-SYNC BUILD)
    Protocol: Restore V8.2 Names & Fix GitHub Asset Paths
   ========================================================================== */
...
window.program = {
    ...
    "Κυριακή": [{ name: "Ποδηλασία (Cycling)", sets: 1, muscleGroup: "Πόδια" }]
};

// --- ΑΥΣΤΗΡΗ ΑΝΤΙΣΤΟΙΧΙΣΗ ΜΕ ΤΑ ΠΡΑΓΜΑΤΙΚΑ .MP4 ΑΡΧΕΙΑ ΤΟΥ GITHUB ---
window.videoMap = {
...
console.log("✅ PEGASUS DATA ENGINE: V8.2 Names Restored & Synced with Assets.");
