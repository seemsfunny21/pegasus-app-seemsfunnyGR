...
window.PegasusKoukiDB = [
    ...
    { name: "Παστίτσιο", type: "carb", price: 6.00, kcal: 950, protein: 42, side: false },
    ...
    { name: "Κοτόπουλο γλυκόξινο", type: "poulika", price: 6.00, kcal: 700, protein: 40, side: false },
    ...
    { name: "Κανελόνια", type: "carb", price: 6.00, kcal: 850, protein: 42, side: false },
    ...
    { name: "Κοντοσούβλι κοτόπουλο", type: "poulika", price: 6.00, kcal: 750, protein: 52, side: false },
    ...
    { name: "Γίγαντες με χόρτα", type: "ospro", price: 6.00, kcal: 480, protein: 25, side: false },
    { name: "Χταπόδι με κοφτό μακαρονάκι", type: "psari", price: 7.00, kcal: 700, protein: 30, side: false },
    ...
    { name: "Γαριδομακαρονάδα", type: "psari", price: 6.50, kcal: 750, protein: 38, side: false },
    { name: "Φιλέτο κοτόπουλο με καρότα", type: "poulika", price: 6.00, kcal: 720, protein: 42, side: false },
    ...
    { name: "Κοντοσούβλι χοιρινό", type: "kreas", price: 6.00, kcal: 780, protein: 40, side: false },
